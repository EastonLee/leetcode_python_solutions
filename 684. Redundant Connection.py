...
class Test(unittest.TestCase):
    ...
    def test(self):
        case = [[1,5],[3,4],[3,5],[4,5],[2,4]]
        assert Solution().findRedundantConnection(case) == [4,5]
        case = [[1,2], [1,3], [2,3]]
        assert Solution().findRedundantConnection(case) == [2,3]
        case = [[1,2], [2,3], [3,4], [1,4], [1,5]]
        assert Solution().findRedundantConnection(case) == [1,4]
